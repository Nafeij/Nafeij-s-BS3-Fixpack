{
	"data": {
		...
		"stitches": {
			...
			"_Thestoneguar": {
				"content": [
					"[dredge_stoneguard_ally_1] /=The stoneguard who joined you near the gates has been carrying the body. He leans over to show Zefr.=/",
					{
			...
			"rookline": {
				"content": [
					"[petrus] Oddleif, I'll have Rook taken somewhere safe. Just until we can pay our respects properly.",
					{
						"divert": "continued"
					},
					{
			...
			"aletteline": {
				"content": [
					"[petrus] Oddleif, I'll have Alette taken somewhere safe. Just until we can pay our respects properly.",
					{
						"divert": "continued"
					},
					{
