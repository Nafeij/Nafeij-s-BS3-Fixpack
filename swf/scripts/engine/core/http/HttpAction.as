package engine.core.http
{
   ...
   public class HttpAction
   {
      ...
      private var _overrideURL:Boolean = false;
      ...
      public function send(param1:HttpCommunicator, param2:Function = null, param3:int = 0, param4:Boolean = false) : void
      {
         if(this.m_sent)
         {
      ...
      private function doSend() : void
      {
         ...
         {
            _loc1_ = this._communicator.request(this.url,this.method,this.body,this.onResponseReceived,this._overrideURL);
         }
      ...
      protected function onResponseReceived(param1:String, param2:Boolean, param3:int) : void
      {
         ...
         if(Boolean(this._communicator) && (!this.consumedTxn || this.isMaintenance))
         {
            this._communicator.onHttpTxnResponseProcessed(this);
         }
