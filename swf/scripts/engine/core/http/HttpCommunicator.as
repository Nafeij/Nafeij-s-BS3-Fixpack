package engine.core.http
{
   ...
   public class HttpCommunicator extends EventDispatcher
   {
      ...
      public function request(param1:String, param2:HttpRequestMethod, param3:Object, param4:Function, param5:Boolean = false) : HttpRequest
      {
         ...
         var overrideURL:Boolean = param5;
         if(!method)
         {
            throw new ArgumentError("fail method");
         }
         requestURL = overrideURL ? url : this.m_hostUrl + url;
         return new HttpRequest(requestURL,method,body,function(param1:*, param2:Boolean, param3:int):void
         {
      ...
      {
         return this.request(param1,HttpRequestMethod.GET,param2,param3);
      }
      
      final public function requestPost(param1:String, param2:Object, param3:Function) : HttpRequest
      {
         return this.request(param1,HttpRequestMethod.POST,param2,param3);
      }
