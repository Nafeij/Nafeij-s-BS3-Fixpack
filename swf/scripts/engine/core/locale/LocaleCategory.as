package engine.core.locale
{
   ...
   public class LocaleCategory extends Enum
   {
      ...
      public static const EA:LocaleCategory = new LocaleCategory("EA",enumCtorKey);
      
      public static const EA_OPT:LocaleCategory = new LocaleCategory("EA_OPT",enumCtorKey);
