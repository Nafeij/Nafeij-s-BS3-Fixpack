package engine.core.util
{
   ...
   public class AppInfo extends EventDispatcher
   {
      ...
      public static const FILE_SORT_NONE:String = "FILE_SORT_NONE";
      
      public static const FILE_SORT_LAST_MODIFIED:String = "FILE_SORT_LAST_MODIFIED";
      
      public static const FILE_SORT_LAST_MODIFIED_DESCENDING:String = "FILE_SORT_LAST_MODIFIED_DESCENDING";
      ...
      public function AppInfo(param1:Sprite, param2:BuildInfo, param3:int)
      {
         ...
         super();
         this._root = param1;
         this._buildInfo = param2;
         this.ordinal = param3;
         instance = this;
      }
      
      public function get buildInfo() : BuildInfo
      {
      ...
      {
         return this._buildInfo.id.number;
      }
      ...
      {
         return new AppInfo(this._root,this._buildInfo,param1);
      }
      ...
      public function listDirectory(param1:String, param2:String, param3:String = "FILE_SORT_NONE") : Array
      {
         return null;
      }
