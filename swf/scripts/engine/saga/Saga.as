package engine.saga
{
   ...
   import engine.core.rewards.Refereum;
   ...
   public class Saga extends EventDispatcher implements ISaga, ISagaCaravanProvider, IVariableProvider, IHappeningProvider, IVariableDefProvider, ISagaCastProvider, IBattleBoardProvider, IBattleEntityProvider
   {
      ...
      public static const VAR_PRG_EA_CHALLENGES_PLAYED:String = "prg_ea_challenges_played";
      
      public static const VAR_PRG_EA_STR_DMG_GIVEN:String = "prg_ea_str_damage_done";
      
      public static const VAR_PRG_EA_ARM_DMG_GIVEN:String = "prg_ea_brk_damage_done";
      
      public static const VAR_PRG_EA_ARM_DMG_TAKEN:String = "prg_ea_arm_damage_taken";
      
      public static const VAR_PRG_EA_WIL_SPENT:String = "prg_ea_wil_spent";
      
      public static const VAR_PRG_EA_ENEMIES_DEFEATED:String = "prg_ea_enemies_defeated";
      
      public static const VAR_PRG_EA_SOLO_ENEMIES_DEFEATED:String = "prg_ea_highest_solo_kills";
      
      public static const VAR_PRG_EA_DEFEAT_COUNT:String = "prg_ea_defeat_count";
      
      public static const VAR_PRG_EA_VICTORY_COUNT:String = "prg_ea_victory_count";
      
      public static const VAR_PRG_EA_SAGA1_SCENES_PLAYED:String = "prg_ea_saga1_scenes_played";
      
      public static const VAR_PRG_EA_SAGA2_SCENES_PLAYED:String = "prg_ea_saga2_scenes_played";
      
      public static const VAR_PRG_EA_SAGA3_SCENES_PLAYED:String = "prg_ea_saga3_scenes_played";
      
      public static const VAR_ACV_EA_AUTHOR:String = "acv_3e_72_arena_author";
      
      public static const VAR_ACV_EA_SAVER:String = "acv_3e_73_arena_saver";
      
      public static const VAR_ACV_EA_SCRIVENER:String = "acv_3e_74_scrivener";
      
      private static const VAR_MASTER_EA_KILLS_PREFIX:String = "ea.kills.";
      
      private static const VAR_MASTER_EA_KILLS_HIGHEST_POSTFIX:String = "highest";
      
      private static const VAR_MASTER_EA_CHALLENGE_HASH:String = "challenge_last_hash";
      
      private static const _achievementProgressVars:Array = [VAR_PRG_EA_CHALLENGES_PLAYED,VAR_PRG_EA_STR_DMG_GIVEN,VAR_PRG_EA_ARM_DMG_GIVEN,VAR_PRG_EA_ARM_DMG_TAKEN,VAR_PRG_EA_WIL_SPENT,VAR_PRG_EA_ENEMIES_DEFEATED,VAR_PRG_EA_SOLO_ENEMIES_DEFEATED,VAR_PRG_EA_DEFEAT_COUNT,VAR_PRG_EA_VICTORY_COUNT,VAR_PRG_EA_SAGA1_SCENES_PLAYED,VAR_PRG_EA_SAGA2_SCENES_PLAYED,VAR_PRG_EA_SAGA3_SCENES_PLAYED];
      ...
      public var eternalArena:SagaEternalArena;
      ...
      public var firstBuildNumber:String;
      ...
      public var _masterSave:ISagaMasterSave;
      ...
      public function Saga(param1:SagaDef, param2:ISoundSystem, param3:ResourceManager, param4:ILogger, param5:BattleAbilityDefFactory, param6:AppInfo, param7:Boolean, param8:Ccs, param9:Locale, param10:SaveManager)
      {
         ...
         this.firstBuildNumber = param6.buildNumber;
         this.ccs = param8;
         param8.reset();
         ...
         if(param1.eternalArena)
         {
            this.eternalArena = new SagaEternalArena(this,param1.eternalArena,param4,param1.classes.meta,param1.talentDefs);
         }
      }
      ...
      public function overrideRNGSeed(param1:int) : void
      {
         this._createRNG(param1);
      }
      ...
      private function _setupRNG() : void
      {
         ...
         this._createRNG(_loc1_);
      }
      
      private function _createRNG(param1:int) : void
      {
         this._rng = new Rng(new RngSampler_SeedArray(param1),this.logger);
         this._logger.i("RNG","RNG seed set to: " + param1);
      }
      ...
      public function reapplyDlcs() : void
      {
         if(this.def.dlcs)
         {
            this.def.dlcs.applyDlcs(this,this.appinfo);
      ...
      public function isDlcVarOwned(param1:String) : Boolean
      {
         return !!this.def.dlcs ? this.def.dlcs.isDlcOwned(param1) : false;
      }
      ...
      private function triggerVariableHandler(param1:VariableEvent) : void
      {
         ...
         var _loc8_:Number = _loc2_.asNumber;
      ...
      private function notifyVarGaCustoms(param1:Variable) : void
      {
         ...
         var _loc2_:int = param1.asInteger;
         if(param1.def.ga_custom_dimension)
         {
      ...
      public function cleanup() : void
      {
         ...
         if(this.eternalArena)
         {
            this.eternalArena.cleanup();
            this.eternalArena = null;
         }
         if(this._masterSave)
         {
            this._masterSave.cleanup();
            this._masterSave = null;
         }
         this.convo = null;
      ...
      public function sendRefereumAllAchievementUnlocks(param1:Boolean = false) : void
      {
         var _loc2_:AchievementDef = null;
         for each(_loc2_ in this.achievements.defs)
         {
            if(this.getVarBool(_loc2_.id))
            {
               Refereum.completeAchievement(_loc2_.id,param1);
            }
         }
      }
      
      private function _retroactivelyNotifyAchievementUnlocks() : void
      {
         this.sendRefereumAllAchievementUnlocks();
      }
      ...
      private function _retroactivelyUpdateEaKills() : void
      {
         ...
         var _loc1_:int = this.getMasterKillCountForEntity(VAR_MASTER_EA_KILLS_HIGHEST_POSTFIX);
         if(_loc1_ > 0)
         {
            return;
         }
         for(_loc2_ in this.masterSave)
         {
            if(_loc2_ != VAR_MASTER_EA_KILLS_PREFIX + VAR_MASTER_EA_KILLS_HIGHEST_POSTFIX && _loc2_.indexOf(VAR_MASTER_EA_KILLS_PREFIX) == 0)
            {
               _loc3_ = this.getMasterSaveKeyInt(_loc2_);
               if(_loc3_ > _loc1_)
               {
                  _loc1_ = _loc3_;
                  this.logger.debug("Saga::retroactivelyUpdateEaKills - Found a higher kill count than previous max at [" + _loc1_ + "]");
                  this.setMasterSaveKey(VAR_MASTER_EA_KILLS_PREFIX + VAR_MASTER_EA_KILLS_HIGHEST_POSTFIX,_loc1_);
               }
            }
         }
         this.setVar(VAR_PRG_EA_SOLO_ENEMIES_DEFEATED,_loc1_);
      }
      ...
      public function start(param1:String, param2:int, param3:SagaSave, param4:String) : void
      {
         ...
         this._retroactivelyUpdateEaKills();
         this._retroactivelyNotifyAchievementUnlocks();
         this.eaLoadAchievementProgressVariables();
         ...
         else if(this.def.eternalArena)
         {
            this.eternalArenaHandleStart();
         }
      ...
      protected function eternalArenaHandleStart() : void
      {
      }
      ...
      private function triggerVariableThresholdUp(param1:Variable, param2:Number) : void
      {
         ...
         var _loc3_:Number = param1.asNumber;
         if(_loc3_ <= param2)
         {
            return;
         }
      ...
      {
         var _loc3_:int = this._vars.incrementGlobalVar(param1,this.isAchievementsSuppressed,param2);
         if(this.isEternalArena && _loc3_ > 0)
         {
            if(_achievementProgressVars.indexOf(param1) != -1)
            {
               this.setMasterSaveKey(param1,_loc3_);
            }
         }
         return _loc3_;
      }
      ...
      public function triggerBattleUnitKilled(param1:IBattleEntity) : void
      {
         ...
         else if(param1.isEnemy)
         {
            ...
            {
               this.incrementGlobalVar(VAR_PRG_EA_ENEMIES_DEFEATED);
            }
         }
      ...
      public function triggerBattleFinished(param1:String) : void
      {
         ...
         if(!this.inTrainingBattle)
         {
            ...
            if(this.isEternalArena)
            {
               ...
               if(this.eternalArena.arrangement)
               {
                  ...
                  {
                     case "saga1":
                        this.incrementGlobalVar(VAR_PRG_EA_SAGA1_SCENES_PLAYED);
                        break;
                     case "saga2":
                        this.incrementGlobalVar(VAR_PRG_EA_SAGA2_SCENES_PLAYED);
                        break;
                     case "saga3":
                        this.incrementGlobalVar(VAR_PRG_EA_SAGA3_SCENES_PLAYED);
                        break;
                     default:
                        this.logger.debug("Saga::TriggerBattleFinished - Attempted to increment the SCENES_PLAYED achievement, but got an invalid sagaId [" + _loc8_ + "]");
                  }
                  if(this.eternalArena && this.eternalArena.challenge && this.eternalArena.isChallengeArrangement && this.eternalArena.challenge.configHash != this.getMasterSaveKey(VAR_MASTER_EA_CHALLENGE_HASH))
                  {
                     this.setMasterSaveKey(VAR_MASTER_EA_CHALLENGE_HASH,this.eternalArena.challenge.configHash);
                     this.incrementGlobalVar(Saga.VAR_PRG_EA_CHALLENGES_PLAYED);
                  }
               }
            }
            if(this._caravan)
         ...
         this.triggerBattleFinallyFinished(param1,_loc7_);
      }
      ...
      public function triggerBattleFinallyFinished(param1:String, param2:Boolean) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            if(!_loc4_.ended)
            {
               _loc4_.triggerBattleFinished(param1);
            }
         }
         this.eternalArena && this.eternalArena.handleBattleEnded(param2);
      }
      ...
      public function triggerBattleStart() : void
      {
         ...
         this.eternalArena && this.eternalArena.handleBattleStarted(_loc2_);
      }
      ...
      public function setCaravanById(param1:String) : void
      {
         ...
         if(param1)
         {
            ...
            if(!_loc2_)
            {
               this.logger.error("Saga.setCaravanById [" + param1 + "] no such caravan on saga " + this.def.id);
            }
            this.caravan = _loc2_;
         }
         else
      ...
      private function restTimerHandler(param1:TimerEvent) : void
      {
         ...
         var _loc3_:Number = (getTimer() - this.rest_start_wallclock) * this.rest_speed;
      ...
      public function loadFromSave(param1:SagaSave) : void
      {
         ...
         this.firstBuildNumber = param1.build_first;
      ...
      public function incrementMasterKillCountForEntity(param1:String, param2:int = 1) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.isEternalArena)
         {
            _loc3_ = this.getMasterSaveKeyInt(VAR_MASTER_EA_KILLS_PREFIX + param1);
            this.setMasterSaveKey(VAR_MASTER_EA_KILLS_PREFIX + param1,_loc3_ + param2);
            _loc4_ = this.getMasterSaveKeyInt(VAR_MASTER_EA_KILLS_PREFIX + VAR_MASTER_EA_KILLS_HIGHEST_POSTFIX);
            if(_loc3_ > _loc4_)
            {
               this.setMasterSaveKey(VAR_MASTER_EA_KILLS_PREFIX + VAR_MASTER_EA_KILLS_HIGHEST_POSTFIX,_loc3_);
               this.setVar(VAR_PRG_EA_SOLO_ENEMIES_DEFEATED,_loc3_);
            }
         }
      }
      
      public function getMasterKillCountForEntity(param1:String) : int
      {
         return this.isEternalArena ? this.getMasterSaveKeyInt(VAR_MASTER_EA_KILLS_PREFIX + param1) : 0;
      }
      ...
      public function showSaveProfileLoad(param1:Function = null) : void
      {
      }
      
      public function showSaveProfileStart(param1:Function, param2:Function = null) : void
      {
      }
      ...
      public function getCastMember(param1:String) : IEntityDef
      {
         ...
         {
            logger.error("Saga.getCastMember failed: " + e.getStackTrace());
            return null;
         }
                  ...
                  if(_loc13_)
                  {
                     switch(_loc13_.def.type)
                     {
                        case VariableType.INTEGER:
                           _loc14_ = (_loc13_.asInteger * (_loc12_ ? -1 : 1)).toString();
                           break;
                        case VariableType.DECIMAL:
                           _loc14_ = (_loc13_.asNumber * (_loc12_ ? -1 : 1)).toString();
                           break;
                        default:
      ...
      private function applyUnitDifficultyBonus(param1:IBattleEntity, param2:StatType, param3:int) : void
      {
         ...
         var _loc5_:int = _loc4_.base;
         var _loc6_:int = _loc4_.base > 0 ? 1 : 0;
      ...
      public function get isEternalArena() : Boolean
      {
         return Boolean(this.def) && Boolean(this.def.eternalArena);
      }
      
      public function get isInBattle() : Boolean
      {
         return this.getBattleBoard() != null;
      }
      ...
      public function get sagaDefId() : String
      {
         return this.def.id;
      }
      
      public function get isEternalArenaPillage() : Boolean
      {
         return Boolean(this.eternalArena) && this.eternalArena.isPillage;
      }
      
      public function getBattleAbilityDef(param1:String) : IBattleAbilityDef
      {
         return this.abilityFactory.fetch(param1,false) as IBattleAbilityDef;
      }
      
      public function get useRenown() : Boolean
      {
         return null == this.eternalArena;
      }
      
      public function resetConsumedTitles() : Boolean
      {
         if(this.def == null || this.def.consumedTitles == null)
         {
            return false;
         }
         this.def.consumedTitles.splice(0,this.def.consumedTitles.length);
         return true;
      }
      
      public function unConsumeTitle(param1:ITitleDef) : void
      {
         this.def.unConsumeTitle(param1);
      }
      
      public function consumeTitle(param1:ITitleDef) : void
      {
         this.def.consumeTitle(param1);
      }
      
      public function get iSagaDef() : ISagaDef
      {
         return this.def;
      }
      
      public function unlockAchievementById(param1:String) : void
      {
         SagaAchievements.unlockAchievementById(param1,this.minutesPlayed,true);
      }
      
      public function eaSaveArrangement() : void
      {
         SagaAchievements.unlockAchievementById(VAR_ACV_EA_SAVER,this.minutesPlayed,true);
         if(this.eternalArena.isChallengeArrangement)
         {
            SagaAchievements.unlockAchievementById(VAR_ACV_EA_SCRIVENER,this.minutesPlayed,true);
         }
      }
      
      public function eaLoadAchievementProgressVariables() : void
      {
         var _loc1_:String = null;
         if(!this.isEternalArena || !this.masterSave)
         {
            return;
         }
         for each(_loc1_ in _achievementProgressVars)
         {
            this.setVar(_loc1_,this.getMasterSaveKeyInt(_loc1_));
         }
      }
      ...
      public function resetMasterSave() : void
      {
         ...
         var _loc1_:Array = this._getChildKeys();
         this._masterSave = new SagaMasterSave(this,this.saveManager,this.appinfo,_loc1_);
      }
      
      private function _getChildKeys() : Array
      {
         var _loc1_:Array = [];
         this.def.survivalSagaKey && _loc1_.push(this.def.survivalSagaKey);
         this.def.eternalArenaSagaKey && _loc1_.push(this.def.eternalArenaSagaKey);
         return _loc1_;
      }
      
      public function get masterSave() : ISagaMasterSave
      {
         return this._masterSave;
      }
      
      public function setMasterSaveKey(param1:String, param2:*) : void
      {
         this._masterSave && this._masterSave.setMasterSaveKey(param1,param2);
      }
      
      public function getMasterSaveKeyBool(param1:String) : Boolean
      {
         return Boolean(this._masterSave) && this._masterSave.getMasterSaveKeyBool(param1);
      }
      
      public function getMasterSaveKey(param1:String) : *
      {
         return !!this._masterSave ? this._masterSave.getMasterSaveKey(param1) : undefined;
      }
      
      public function getMasterSaveKeyInt(param1:String) : int
      {
         return !!this._masterSave ? this._masterSave.getMasterSaveKeyInt(param1) : 0;
      }
      
      public function incrementMasterSaveKey(param1:String) : void
      {
         this._masterSave && this._masterSave.incrementMasterSaveKey(param1);
      }
      
      public function storeMasterSave(param1:Boolean) : void
      {
         this._masterSave && this._masterSave.storeMasterSave(param1);
      }
      
      public function handleMasterSaveInitialized() : void
      {
         this.hoistAchievementsFromMaster();
      }
   }
}
