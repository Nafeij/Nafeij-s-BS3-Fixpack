package engine.saga.save
{
   ...
   public class SagaSaveCastEntity
   {
      ...
      public var selectAdditionalAbility:Boolean;
      ...
      public function fromEntity(param1:IEntityDef, param2:ILogger) : SagaSaveCastEntity
      {
         ...
         if(param1.selectAdditionalAbility)
         {
            this.selectAdditionalAbility = param1.selectAdditionalAbility;
         }
         if(param1.defItem)
         {
         ...
         while(_loc4_ < param1.stats.numStats)
         {
            ...
            if(_loc8_)
            {
               _loc7_ = Math.max(0,_loc6_.base - _loc8_.min);
            }
            if(_loc7_ > 0)
            {
               _loc3_ += _loc7_;
            ...
            else if(_loc7_ < 0 && Boolean(_loc8_))
            {
            ...
            if(param1.talents)
            {
               ...
               if(Boolean(_loc9_) && _loc9_.rank > 0)
               {
                  if(!this.talents)
                  {
         ...
         if(Boolean(param1.actives) && Boolean(param1.actives.numAbilities))
         {
            if(!this.actives)
            {
      ...
      public function applyCastInfo(param1:IEntityDef, param2:Saga, param3:ILogger, param4:Dictionary) : void
      {
         ...
         param1.selectAdditionalAbility = this.selectAdditionalAbility;
      }
      ...
      private function applyCastInfoHeroicTitle(param1:IEntityDef, param2:Saga, param3:ILogger) : void
      {
         ...
         if(this.heroicTitle && param2.def && Boolean(param2.def.titleDefs))
         {
         ...
         for each(kvp in this.actives)
         {
            try
            {
               ...
               if(rankAcquired >= 6)
               {
                  ...
                  {
                     acts = e.actives;
                     index = acts.getAbilityIndex(kvp.id);
                     if(index >= 0)
                     {
      ...
      public function toJson() : Object
      {
         ...
         _loc1_.selectAdditionalAbility = this.selectAdditionalAbility;
         if(this.item)
         {
         ...
         if(Boolean(this.actives) && Boolean(this.actives.length))
         {
            _loc1_.actives = [];
