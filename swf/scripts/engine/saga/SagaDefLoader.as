package engine.saga
{
   ...
   import engine.saga.ea.SagaEternalArenaDef;
   ...
   public class SagaDefLoader
   {
      ...
      public var eternalArenaDef:SagaEternalArenaDef;
      
      public var eternalArenaBoards:EternalArenaBoards;
      ...
      private function resourceHandler(param1:ResourceLoadedEvent) : void
      {
         ...
         if(this.sagaDef.eternalArenaUrl)
         {
            this.wranglers.wrangle(this.sagaDef.eternalArenaUrl);
         }
         if(this.sagaDef.eternalArenaBoardsUrl)
         {
            this.wranglers.wrangle(this.sagaDef.eternalArenaBoardsUrl);
         }
         if(this.sound)
         {
      ...
      private function finishEternalArena() : void
      {
         var _loc1_:DefWrangler = null;
         if(this.sagaDef.eternalArenaBoardsUrl)
         {
            _loc1_ = this.wranglers.wrangled(this.sagaDef.eternalArenaBoardsUrl);
            this.eternalArenaBoards = new EternalArenaBoards(this.sagaDef.id).fromText(_loc1_.text,this.logger);
         }
         if(this.sagaDef.eternalArenaUrl)
         {
            _loc1_ = this.wranglers.wrangled(this.sagaDef.eternalArenaUrl);
            this.sagaDef.eternalArena = new SagaEternalArenaDef().fromJson(_loc1_.vars,this.logger,this.eternalArenaBoards,this.sagaDef.buckets);
         }
      }
