package engine.saga
{
   ...
   public class SagaDefVars extends SagaDef
   {
      ...
      public static function toJson(param1:SagaDef) : Object
      {
         ...
         if(param1.survival)
         {
            _loc2_.survival = true;
         }
         if(param1.parentSagaUrl)
         {
            _loc2_.parentSagaUrl = param1.parentSagaUrl;
         }
         ...
         if(param1.eternalArenaBoardsUrl)
         {
            _loc2_.eternalArenaBoardsUrl = param1.eternalArenaBoardsUrl;
         }
         if(param1.eternalArenaUrl)
         {
            _loc2_.eternalArenaUrl = param1.eternalArenaUrl;
         }
         if(param1.eternalArenaSagaKey)
         {
            _loc2_.eternalArenaSagaKey = param1.eternalArenaSagaKey;
         }
         if(param1.eternalArenaSagaUrl)
         {
            _loc2_.eternalArenaSagaUrl = param1.eternalArenaSagaUrl;
         }
         if(param1.survivalSagaKey)
         {
            _loc2_.survivalSagaKey = param1.survivalSagaKey;
         }
         if(param1.survivalSagaUrl)
         {
            _loc2_.survivalSagaUrl = param1.survivalSagaUrl;
         }
         return _loc2_;
      }
      ...
      public function fromJson(param1:Object, param2:ILogger, param3:Boolean) : SagaDefVars
      {
         ...
         survivalSagaUrl = param1.survivalSagaUrl;
         survivalSagaKey = param1.survivalSagaKey;
         eternalArenaBoardsUrl = param1.eternalArenaBoardsUrl;
         eternalArenaUrl = param1.eternalArenaUrl;
         eternalArenaSagaKey = param1.eternalArenaSagaKey;
         eternalArenaSagaUrl = param1.eternalArenaSagaUrl;
         parentSagaUrl = param1.parentSagaUrl;
         if(_startUrl)
         {
            if(Boolean(eternalArenaUrl) || Boolean(survival))
            {
               param2.error("Survival nor EA support start scene URLs");
            }
         }
