package engine.saga
{
   ...
   public class SagaDef implements ISagaDef
   {
      ...
      public static var ETERNAL_ARENA_ENABLED:Boolean;
      ...
      public var eternalArena:SagaEternalArenaDef;
      ...
      public var survivalSagaUrl:String;
      
      public var survivalSagaKey:String;
      
      public var eternalArenaSagaUrl:String;
      
      public var eternalArenaSagaKey:String;
      
      public var eternalArenaUrl:String;
      
      public var eternalArenaBoardsUrl:String;
      ...
      public function unConsumeTitle(param1:ITitleDef) : void
      {
         ...
         while(_loc2_ < this._consumedTitles.length)
         {
            if(this._consumedTitles[_loc2_] == param1.id)
            {
               this._consumedTitles.splice(_loc2_,1);
               return;
            }
            _loc2_++;
         }
      ...
      {
         this.happenings.handleRenameBucket(param1,param2);
      }
   }
}
