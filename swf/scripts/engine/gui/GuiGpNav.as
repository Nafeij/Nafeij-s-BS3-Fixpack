package engine.gui
{
   ...
   public class GuiGpNav
   {
      ...
      private var _callbackPostNavigate:Function;
      ...
      public function setCallbackPostNavigate(param1:Function) : GuiGpNav
      {
         this._callbackPostNavigate = param1;
         return this;
      }
      ...
      public function navigate(param1:int) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this._callbackPostNavigate != null)
               {
                  this._callbackPostNavigate();
               }
               if(this._navIcon)
               {
                  this._navIcon.pulse();
