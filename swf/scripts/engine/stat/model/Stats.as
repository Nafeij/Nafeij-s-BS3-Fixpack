package engine.stat.model
{
   ...
   public class Stats
   {
      ...
      private static var _userChangedStatVect:Vector.<StatType>;
      ...
      public static function get userChangeStatVect() : Vector.<StatType>
      {
         var _loc1_:int = 0;
         if(!_userChangedStatVect)
         {
            _userChangedStatVect = new Vector.<StatType>();
            _loc1_ = 0;
            while(_loc1_ < userChangedStatTypes.length)
            {
               _userChangedStatVect.push(userChangedStatTypes[_loc1_]);
               _loc1_++;
            }
         }
         return _userChangedStatVect;
      }
