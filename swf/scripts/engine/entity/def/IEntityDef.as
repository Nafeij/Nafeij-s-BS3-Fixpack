package engine.entity.def
{
   ...
   public interface IEntityDef extends IId, INamed, IStatsProvider, IEventDispatcher, IVariableDefProvider
   {
      ...
      function get selectAdditionalAbility() : Boolean;
      
      function set selectAdditionalAbility(param1:Boolean) : void;
      ...
      function get eaKillCounterId() : String;
      ...
      function doApplyRankLimits(param1:int, param2:int, param3:UnitStatCosts, param4:ILogger) : void;
      
      function spendPoints(param1:EternalArenaCastModifiers, param2:EntitiesMetadata, param3:UnitStatCosts, param4:TalentDefs) : void;
      
      function get maxEATitleRank() : uint;
      
      function get respecAvailable() : Boolean;
      
      function doFullRespec(param1:ISaga, param2:Boolean = true) : void;
   }
}
