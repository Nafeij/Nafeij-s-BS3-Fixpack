package engine.entity.def
{
   ...
   public class EntityDefVars extends EntityDef
   {
      ...
      public static function save(param1:EntityDef, param2:ILogger) : Object
      {
         ...
         if(param1.eaKillCounterOverride)
         {
            _loc3_.eaKillCounterOverride = param1.eaKillCounterOverride;
         }
         if(param1._additionalActives)
         {
            _loc3_.additionalActives = ArrayUtil.stringVectorToStringArray(param1._additionalActives);
         }
         if(param1.selectAdditionalAbility)
         {
            _loc3_.selectAdditionalAbility = param1.selectAdditionalAbility;
         }
         ...
         {
            _loc3_.addDifficultyStatsAsMods = param1._addDifficultyStatsAsMods;
         }
         return _loc3_;
      }
      ...
      public function fromJson(param1:Object, param2:ILogger, param3:AbilityDefFactory, param4:EntityClassDefList, param5:IBattleEntityProvider, param6:Boolean, param7:ItemListDef, param8:UnitStatCosts) : EntityDefVars
      {
         ...
         selectAdditionalAbility = json.selectAdditionalAbility;
         _cachedSelectAdditionalAbility = _selectAdditionalAbility;
         ...
         this._eaKillCounterOverride = json.eaKillCounterOverride;
