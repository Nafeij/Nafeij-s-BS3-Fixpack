package engine.scene.model
{
   ...
   public class Scene extends EventDispatcher implements IScene
   {
      ...
      public function prepareBoard(param1:String, param2:BattleScenarioDef, param3:Boolean, param4:String, param5:EternalArenaScorecard) : BattleBoard
      {
         ...
         var _loc6_:BattleBoardDef = this._def.getBoard(param1);
         if(!_loc6_)
         {
            throw new ArgumentError("No such board: " + param1 + " for " + this._def.url);
         }
         var _loc7_:BattleBoard = new BattleBoard(_loc6_,param2,this,this._context.logger,this._context.resman,this._context.abilities,this._context.battleAssets,this._context.soundDriver,param4,this._context.saga);
         var _loc8_:BattleFsmConfig = new BattleFsmConfig();
         var _loc9_:BattleFsm = new BattleFsm(this._context.session,_loc7_,this._context.logger,_loc8_,this.battleCreateData,this.battleOrder,param3,this._context.chat,this._context.fsm);
         _loc7_.sim = new BattleSim(_loc7_,_loc9_);
         this.boards.push(_loc7_);
         _loc7_.addEventListener(BattleBoardEvent.ENABLED,this.boardEnabledHandler);
         if(_loc7_.enabled)
         {
