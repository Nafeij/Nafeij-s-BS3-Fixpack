package engine.battle.board
{
   ...
   public class BattleBoardEvent extends Event
   {
      ...
      public static const BOARD_ENTITY_TURN_STARTED:String = "BattleEntityEvent.BOARD_ENTITY_TURN_STARTED";
      ...
      public function BattleBoardEvent(param1:String, param2:IBattleEntity = null, param3:IBattleEntity = null, param4:StatType = null, param5:int = 0)
      {
         super(param1,false,false);
         this.entity = param2;
         this.other = param3;
         this.statType = param4;
         this.amount = param5;
      }
