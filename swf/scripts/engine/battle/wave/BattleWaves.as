package engine.battle.wave
{
   ...
   public class BattleWaves extends EventDispatcher
   {
      ...
      public function overrideBuckets(param1:Vector.<String>) : void
      {
         var _loc3_:BattleWaveDef = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.def.waves.length)
         {
            _loc3_ = this.def.waves[_loc2_];
            _loc3_.bucket.bucketId = param1.length > _loc2_ ? param1[_loc2_] : param1[param1.length - 1];
            _loc3_.bucket.guaranteedSpawns.length = 0;
            _loc2_++;
         }
      }
   }
