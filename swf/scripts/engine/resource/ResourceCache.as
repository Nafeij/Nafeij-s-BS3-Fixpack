package engine.resource
{
   ...
   public class ResourceCache
   {
      ...
      public function ResourceCache(param1:AppInfo)
      {
         ...
         if(this.cacheVersion != param1.buildNumber)
         {
            param1.logger.info("ResourceCache version [" + this.cacheVersion + "] does not match app version [" + param1.buildNumber + "]");
            this.cacheVersion = param1.buildNumber;
            _loc4_ = true;
         }
