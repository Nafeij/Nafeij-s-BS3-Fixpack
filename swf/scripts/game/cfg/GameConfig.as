package game.cfg
{
   ...
   public class GameConfig extends EventDispatcher implements IBattleBoardProvider, IBattleEntityProvider
   {
      ...
      public function GameConfig(param1:EngineCoreContext, param2:Class, param3:Class, param4:Function, param5:IDialogLayer, param6:SaveManager, param7:int)
      {
         ...
         param1.logger.info("      Id Version: " + param1.appInfo.buildInfo.id.version);
         param1.logger.info("      Id  Number: " + param1.appInfo.buildInfo.id.number);
         param1.logger.info(" Builder     Tag: " + param1.appInfo.buildInfo.builder.tag);
         param1.logger.info(" Builder    Date: " + param1.appInfo.buildInfo.builder.date);
         param1.logger.info("     Scm    Type: " + param1.appInfo.buildInfo.scm.scm);
         param1.logger.info("     Scm     Rev: " + param1.appInfo.buildInfo.scm.rev);
      ...
      public function startLoading() : void
      {
         ...
         {
            _loc3_ = new URLRequest("http://stoicstudio.com/deploy/dev/" + this.context.appInfo.buildNumber + "/news.json");
      ...
      private function sagaLoadedHandler(param1:Saga) : void
      {
         ...
         if(!this.saga.parentSagaUrl)
         {
            this.saga.parentSagaUrl = this.saga.def.parentSagaUrl;
         }
