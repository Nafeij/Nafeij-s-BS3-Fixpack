package game.view
{
   ...
   import game.gui.page.SagaEternalArenaLeaderboardsPage;
   import game.gui.page.SagaEternalArenaSetupPage;
   import game.gui.page.SagaEternalArenaStartPage;
   ...
   public class GamePageManagerAdapter extends PageManagerAdapter
   {
      ...
      public function GamePageManagerAdapter(param1:GameConfig, param2:DisplayObjectContainer, param3:int)
      {
         ...
         registerFsmStatePageClass(SagaEternalArenaStartState,SagaEternalArenaStartPage);
         registerFsmStatePageClass(SagaEternalArenaSetupState,SagaEternalArenaSetupPage);
         registerFsmStatePageClass(SagaEternalArenaLeaderboardsState,SagaEternalArenaLeaderboardsPage);
      ...
      public function showSaveProfileLoad(param1:Boolean, param2:Function = null) : void
      {
         if(param1)
         {
            this._showSaveProfile(SaveProfilePageMode.PROFILE_MODE_RESUME,SagaDef.START_HAPPENING,param2);
         }
         else
         {
            this._showSaveProfile(SaveProfilePageMode.PROFILE_MODE_LOAD,SagaDef.START_HAPPENING,param2);
         }
      }
      
      public function showSaveProfileStart(param1:String, param2:Function = null, param3:Function = null) : void
      {
         this._showSaveProfile(SaveProfilePageMode.PROFILE_MODE_NEW_GAME_WHILE_FULL,param1,param3,param2);
      }
