package game.gui.pages
{
   ...
   public class GuiTitleRankChanger extends GuiBase
   {
      ...
      private var _curEntity:IEntityDef;
      
      private var _isEternalArena:Boolean = false;
      ...
      public function init(param1:IGuiContext, param2:GuiHeroicTitles) : void
      {
         ...
         this._isEternalArena = _context.saga.isEternalArena;
      ...
      {
         if(this._isEternalArena)
         {
            return !(this._guiTitles.currentCharacter && param1 > this._guiTitles.currentCharacter.maxEATitleRank);
         }
