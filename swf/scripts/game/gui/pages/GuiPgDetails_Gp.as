package game.gui.pages
{
   ...
   public class GuiPgDetails_Gp
   {
      ...
      public function refreshGui() : void
      {
         ...
         this.nav.autoSelect();
         this.nav.setSelected(this.nav.selected,true);
      }
      ...
      public function cmdfunc_x(param1:CmdExec) : void
      {
         ...
         else if(this.details._respecBanner.visible)
         {
            this.details._respecBanner.doPress(false);
         }
      }
      ...
      private function cmdfunc_items(param1:CmdExec) : void
      {
         ...
         if(this.details._respecBanner.bannerVisible)
         {
            this.details._respecBanner.extended = false;
         }
      ...
      public function heroicTitleToggleGpHandler() : void
      {
         ...
         else
         {
            ...
            this._details_item.visible = !(this.details._promoteBanner.bannerVisible && this.details._promoteBanner.extended && this.details._respecBanner.bannerVisible && this.details._respecBanner.extended);
         }
      }
