package game.gui.pages
{
   ...
   public class GuiPgDetails extends GuiBase implements IGuiCharacterStatsListener, IGuiBioListener, IGuiPromotionListener
   {
      ...
      private function respecBannerHandler(param1:Event) : void
      {
         ...
         var _loc3_:String = _context.translate("ea_reset");
         var _loc4_:String = _context.translate("cancel");
         var _loc5_:String = _context.translate("ea_respec_confirm_title");
         var _loc6_:String = _context.translate("ea_respec_confirm_body");
      ...
      {
         var _loc2_:String = _context.translate("ea_reset");
         if(_loc2_ == param1)
         {
