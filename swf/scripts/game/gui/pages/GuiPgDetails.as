package game.gui.pages
{
   ...
   public class GuiPgDetails extends GuiBase implements IGuiCharacterStatsListener, IGuiBioListener, IGuiPromotionListener
   {
      ...
      public var _respecBanner:GuiRespecBanner;
      ...
      public function GuiPgDetails()
      {
         ...
         this._respecBanner = getChildByName("respecBanner") as GuiRespecBanner;
      ...
      public function init(param1:IGuiContext, param2:IGuiPgAbilityPopup, param3:GuiProvingGrounds, param4:IGuiButton, param5:GuiCharacterStatsConfig) : void
      {
         ...
         this._characterStats.abilityPopup.addEventListener(this._characterStats.abilityPopup.EVENT_ABILITY_SELECTED,this.abilitySelectedHandler);
         ...
         this._respecBanner.init(param1,param3.guiConfig);
         this._respecBanner.addEventListener(GuiRespecBanner.EVENT_RESPEC,this.respecBannerHandler);
         this._respecBanner.addEventListener(Event.CHANGE,this.promoteBannerChangeHandler);
      ...
      public function cleanup() : void
      {
         ...
         this._respecBanner.removeEventListener(GuiRespecBanner.EVENT_RESPEC,this.respecBannerHandler);
         this._respecBanner.removeEventListener(Event.CHANGE,this.promoteBannerChangeHandler);
         this.selectedCharacter = null;
         this._characterStats.abilityPopup.removeEventListener(this._characterStats.abilityPopup.EVENT_ABILITY_SELECTED,this.promoteBannerChangeHandler);
         ...
         this._respecBanner.cleanup();
         this._respecBanner = null;
      ...
      {
         var _loc1_:Boolean = (!this._promoteBanner.extended || !this._promoteBanner.bannerVisible) && (!this._respecBanner.extended || !this._respecBanner.bannerVisible) && !this._promotion.visible && !this.guiHeroicTitles.visible && !this.guiHeroicTitleTutorial.visible;
         if(_loc1_)
         {
      ...
      public function setGuiHeroicTitlesVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.setThingVisible(this._respecBanner,false);
      ...
      private function abilitySelectedHandler(param1:Event) : void
      {
         this._respecBanner.update();
      }
      
      private function respecBannerHandler(param1:Event) : void
      {
         var _loc2_:IGuiDialog = _context.createDialog();
         var _loc3_:String = String(_context.translate("ea_reset"));
         var _loc4_:String = String(_context.translate("cancel"));
         var _loc5_:String = String(_context.translate("ea_respec_confirm_title"));
         var _loc6_:String = String(_context.translate("ea_respec_confirm_body"));
         _loc2_.openTwoBtnDialog(_loc5_,_loc6_,_loc3_,_loc4_,this.respecConfirmHandler);
      }
      
      private function respecConfirmHandler(param1:String) : void
      {
         var _loc2_:String = String(_context.translate("ea_reset"));
         if(_loc2_ == param1)
         {
            if(_context.saga.isEternalArena && Boolean(_context.saga.eternalArena))
            {
               _context.saga.eternalArena.gaReportHeroRespec(this.selectedCharacter);
            }
            this.selectedCharacter.doFullRespec(_context.saga);
            this._characterStats.setCurrentCharacterIndex(this.selectedCharacter);
            this.populateCharacterElements();
         }
         this._respecBanner.update();
      ...
      protected function populateCharacterElements() : void
      {
         ...
         if(!this.selectedCharacter)
         {
            ...
            this._respecBanner.unitId = null;
            return;
         }
         ...
         this._respecBanner.unitId = this.selectedCharacter.id;
         this.checkDetailsItemVisible();
         this.gp.refreshGui();
      }
