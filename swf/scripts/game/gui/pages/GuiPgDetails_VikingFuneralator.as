package game.gui.pages
{
   ...
   public class GuiPgDetails_VikingFuneralator
   {
      ...
      public function GuiPgDetails_VikingFuneralator(param1:GuiPgDetails)
      {
         ...
         switch(this.saga.def.id)
         {
            case "saga2s":
               this.musics = new Array("saga2/music/ch9/9mC-V","saga2/music/ch11/11mC3-V","saga2/music/ch13/13mC-V");
               break;
            case "saga3s":
               this.musics = new Array("saga3/music/ch16/16mCV","saga3/music/ch19/19mCV","saga3/music/ch20/20mC2-V");
         }
      }
