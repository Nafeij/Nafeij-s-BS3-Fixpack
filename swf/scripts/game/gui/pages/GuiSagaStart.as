package game.gui.pages
{
   ...
   public class GuiSagaStart extends GuiBase implements IGuiSagaStart
   {
      ...
      public var _button_eternal_arena:ButtonWithIndex;
      ...
      public function cleanup() : void
      {
         ...
         this._button_eternal_arena.cleanup();
         ...
         TweenMax.killTweensOf(this._button_eternal_arena);
      ...
      public function init(param1:IGuiContext, param2:IGuiSagaStartListener, param3:Boolean, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:String = null) : void
      {
         var _loc9_:Boolean = false;
         var _loc10_:ButtonWithIndex = null;
         ...
         {
            Log.getLogger("TBS-0").info("User received GUISagaStart: " + param8);
            _loc9_ = true;
         }
         else
         {
            Log.getLogger("TBS-0").info("No user receieved GUISagaStart: " + param8);
         }
         ...
         this._button_eternal_arena = requireGuiChild("button_eternal_arena") as ButtonWithIndex;
         ...
         this._button_eternal_arena.visible = param6 && SagaDef.ETERNAL_ARENA_ENABLED;
         this._button_eternal_arena.x = -this._button_eternal_arena.width;
         ...
         this._showRecap = param7;
         this._button$recap_tbs1.visible = param7;
         ...
         for each(_loc10_ in this.buttons)
         {
            _loc10_.autoSizeText = TextFieldAutoSize.RIGHT;
         }
         _loc11_ = Boolean(_context.saga) && Boolean(_context.saga.parentSagaUrl);
         this._button$quit.visible = GuiSagaStartConfig.ENABLE_QUIT || _loc11_;
         this._button$xbox_gamertag.y = -792;
         this._button$xbox_gamertag.visible = _loc9_;
         ...
         this._button_eternal_arena.guiButtonContext = param1;
         ...
         this._button_eternal_arena.setDownFunction(this.buttonDownHandler);
      ...
      {
         this._handleLeftSideButtons(this._button_eternal_arena);
      ...
      override public function set visible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this._showLeftBanner(this._button_eternal_arena);
      ...
      public function buildNav() : void
      {
         ...
         if(this._button_eternal_arena.visible)
         {
            this.nav.add(this._button_eternal_arena);
         }
      ...
      private function buttonDownHandler(param1:ButtonWithIndex) : void
      {
         switch(param1)
         {
            ...
            case this._button_tbs2_survival:
               this.listener.guiSagaSurvival();
               this._button_tbs2_survival.setStateToNormal();
               return;
            ...
            case this._button$start_tutorial:
               ...
               return;
            case this._button_eternal_arena:
               this.listener.guiSagaEternalArena();
               this._button_eternal_arena.setStateToNormal();
               return;
            default:
               return;
         }
