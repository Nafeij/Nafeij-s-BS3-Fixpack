package game.gui.pages
{
   ...
   public class GuiSagaSurvivalStart extends GuiBase implements IGuiSagaSurvivalStart, ISoundDefBundleListener, IGuiSagaSurvivalLeaderboardsListener
   {
      ...
      public function init(param1:IGuiContext, param2:IGuiSagaSurvivalStartListener, param3:Saga, param4:AppInfo) : void
      {
         ...
         switch(param3.def.id)
         {
            case "saga2s":
               _loc6_.id = "saga2/music/ch14/14mC1-S1-L1";
               break;
            case "saga3s":
               _loc6_.id = "saga3/music/ch16/16mC2-S2";
         }
      ...
      private function setupWelcomeDialog() : void
      {
         ...
         this._welcomeText = this._welcome.getChildByName("ss_welcome_body_1") as TextField;
         this._welcomeTextCount = 1;
         if(this._welcomeText)
         {
            _loc2_ = 2;
            while(_loc1_.hasToken("ss_welcome_body_" + _loc2_.toString()))
            {
      ...
      private function showNextWelcomeDialog() : void
      {
         ...
         if(_loc1_ < this._welcomeTextCount)
         {
            ...
            {
               this._welcomeText.htmlText = context.translateCategory("ss_welcome_body_" + _loc1_.toString(),LocaleCategory.GUI);
      ...
      private function refreshResumeButton() : void
      {
         this.setupResumes();
      ...
      {
         this.saga.showSaveProfileStart(this.profileStartHandler,this.profileCloseHandler);
      }
      ...
      private function profileCloseHandler(param1:*) : void
      {
         this.refreshResumeButton();
      }
      ...
      private function buttonResumeHandler(param1:*) : void
      {
         ...
         {
            this.saga.showSaveProfileLoad(this.profileCloseHandler);
         }
      }
