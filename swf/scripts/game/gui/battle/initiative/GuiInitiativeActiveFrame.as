package game.gui.battle.initiative
{
   ...
   public class GuiInitiativeActiveFrame extends GuiInitiativeFrame
   {
      ...
      public var _bgPulse:MovieClip;
      
      public var _bgPulseMCA:MovieClipAdapter;
      ...
      override public function init(param1:IGuiContext, param2:int, param3:Boolean, param4:Vector.<IEntity>) : void
      {
         ...
         willTweenOut = true;
         this._bgPulse = _iconFrame.getChildByName("bgPulse") as MovieClip;
         this._bgPulse.stop();
         this._bgPulseMCA = new MovieClipAdapter(this._bgPulse,30,0,false,logger);
         this._bgPulse.visible = false;
         this._bgPulseMCA.visible = false;
      }
      ...
      public function showPulse(param1:Boolean) : void
      {
         if(param1)
         {
            _bgPlayer.visible = false;
            _bgEnemy.visible = false;
            this._bgPulseMCA.visible = true;
            this._bgPulseMCA.playLooping();
         }
         else
         {
            this._bgPulse.stop();
