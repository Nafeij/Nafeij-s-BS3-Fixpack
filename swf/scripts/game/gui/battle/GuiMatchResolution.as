package game.gui.battle
{
   ...
   public class GuiMatchResolution extends GuiBase implements IGuiMatchResolution, IGuiMatchResolution_PanelContainer, IGuiMatchResolutionListener, GuiSagaEternalArenaSetup_saveListener
   {
      
      private static var EA_SCORE_OFFSET:int = -70;
      ...
      public var _button_survival$mr_gameover_cap:ButtonWithIndex;
      
      public var _button_survival$survival_reload:ButtonWithIndex;
      
      public var _button_ea$save:ButtonWithIndex;
      
      public var _button_ea$edit:ButtonWithIndex;
      
      public var _button_ea$retry:ButtonWithIndex;
      
      public var _button_ea$quit:ButtonWithIndex;
      
      public var _ea_score_objects:Vector.<GuiEAScoreElement>;
      
      public var _ea_score_total:GuiEAScoreElement;
      
      public var _ea_score_holder:MovieClip;
      
      public var _ea_battle_save:GuiEternalArenaBattleSave;
      ...
      private var _text_retries_remain:TextField;
      ...
      {
         this._ea_score_objects = new Vector.<GuiEAScoreElement>();
         ...
         this._button_survival$mr_gameover_cap = requireGuiChild("button_survival$mr_gameover_cap") as ButtonWithIndex;
         this._button_survival$survival_reload = requireGuiChild("button_survival$survival_reload") as ButtonWithIndex;
         this._button_ea$save = requireGuiChild("button_ea$ea_arena_save_battle") as ButtonWithIndex;
         this._button_ea$edit = requireGuiChild("button_ea$ea_arena_edit") as ButtonWithIndex;
         this._button_ea$retry = requireGuiChild("button_ea$ea_arena_retry") as ButtonWithIndex;
         this._button_ea$quit = requireGuiChild("button_ea$ea_arena_quit") as ButtonWithIndex;
         this._ea_score_holder = requireGuiChild("ea_tally") as MovieClip;
         this._ea_score_total = this._ea_score_holder.getChildByName("score_total") as GuiEAScoreElement;
         this._ea_battle_save = requireGuiChild("battle_save") as GuiEternalArenaBattleSave;
         ...
         this._text_retries_remain = getChildByName("text_retries_remain") as TextField;
         ...
         this._text_retries_remain.mouseEnabled = false;
         this._gameover.visible = false;
         this._text_gameover_desc.visible = false;
         this._text_retries_remain.visible = false;
      ...
      public function init(param1:IGuiMatchPageListener, param2:IBattleScenario, param3:WarOutcome, param4:BattleRewardData, param5:Vector.<String>, param6:Vector.<String>, param7:Boolean, param8:IGuiContext, param9:Boolean) : void
      {
         ...
         this._button_survival$mr_gameover_cap.setDownFunction(this.survivalContinueButtonHandler);
         this._button_survival$survival_reload.setDownFunction(this.survivalReloadButtonHandler);
         this._button_ea$save.setDownFunction(this.eaSaveButtonHandler);
         this._button_ea$edit.setDownFunction(this.eaEditButtonHandler);
         this._button_ea$retry.setDownFunction(this.eaRetryButtonHandler);
         this._button_ea$quit.setDownFunction(this.eaQuitButtonHandler);
         this._button_survival$continue.visible = false;
         this._button_survival$mr_gameover_cap.visible = false;
         this._button_survival$survival_reload.visible = false;
         this._button_ea$save.visible = false;
         this._button_ea$edit.visible = false;
         this._button_ea$retry.visible = false;
         this._button_ea$quit.visible = false;
         this._button_survival$continue.guiButtonContext = _context;
         this._button_survival$mr_gameover_cap.guiButtonContext = _context;
         this._button_survival$survival_reload.guiButtonContext = _context;
         this._button_ea$save.guiButtonContext = _context;
         this._button_ea$edit.guiButtonContext = _context;
         this._button_ea$retry.guiButtonContext = _context;
         this._button_ea$quit.guiButtonContext = _context;
         this._ea_score_holder.visible = false;
         this._ea_score_total.initGuiBase(_context);
         this._ea_score_total.visible = false;
         this._ea_battle_save.setVisible(false);
         this._ea_battle_save.init(_context,this);
         this._setupNav();
         this.startAnimatingMatchResolution();
         this.checkButtonVisibility();
      }
      
      private function showBattleSave(param1:Boolean) : void
      {
         var _loc2_:SagaEternalArena = null;
         if(this._ea_battle_save.visible != param1)
         {
            this._ea_battle_save.setVisible(param1);
            if(param1)
            {
               this.ea_nav.deactivate();
            }
            else
            {
               this.ea_nav.activate();
            }
            this._button_ea$save.enabled = this._button_ea$edit.enabled = this._button_ea$retry.enabled = this._button_ea$quit.enabled = !param1;
            _loc2_ = context.saga.eternalArena;
            if(param1 && Boolean(_loc2_))
            {
               this._ea_battle_save.showSave(_loc2_.currentArrangement);
            }
            this.listener.guiEaSaveShowing(param1);
            this._button_ea$save.visible = !param1;
            this._button_ea$edit.visible = !param1;
            this._button_ea$retry.visible = !param1;
            this._button_ea$quit.visible = !param1;
            this._ea_score_holder.visible = !param1;
         }
      }
      ...
      private function eaSaveButtonHandler(param1:ButtonWithIndex) : void
      {
         this.showBattleSave(true);
      }
      
      private function eaEditButtonHandler(param1:ButtonWithIndex) : void
      {
         this.listener.editEternalArenaClickHandler(param1);
      }
      
      private function eaRetryButtonHandler(param1:ButtonWithIndex) : void
      {
         this.listener.newGameButtonClickHandler(param1);
      }
      
      private function eaQuitButtonHandler(param1:ButtonWithIndex) : void
      {
         this.listener.quitGameButtonClickHandler(param1);
      }
      ...
      {
         this.ea_nav = new GuiGpNav(context,"ea_match_resolution_nav",this);
         this.ea_nav.alwaysHintControls = true;
         this.ea_nav.add(this._button_ea$save);
         this.ea_nav.add(this._button_ea$edit);
         this.ea_nav.add(this._button_ea$retry);
         this.ea_nav.add(this._button_ea$quit);
         this.ea_nav.autoSelect();
      }
      
      public function cleanup() : void
      {
         var _loc2_:GuiEAScoreElement = null;
         ...
         this._button_survival$mr_gameover_cap.cleanup();
         this._button_survival$survival_reload.cleanup();
         this._button_ea$save.cleanup();
         this._button_ea$edit.cleanup();
         this._button_ea$retry.cleanup();
         this._button_ea$quit.cleanup();
         this._button_survival$continue = null;
         this._button_survival$mr_gameover_cap = null;
         this._button_survival$survival_reload = null;
         this._button_ea$save = null;
         this._button_ea$edit = null;
         this._button_ea$retry = null;
         this._button_ea$quit = null;
         var _loc1_:int = 0;
         while(_loc1_ < this._ea_score_objects.length)
         {
            _loc2_ = this._ea_score_objects[_loc1_];
            this._ea_score_holder.removeChild(_loc2_);
            _loc2_.cleanup();
            _loc2_ = null;
            _loc1_++;
         }
      ...
      private function checkButtonVisibility() : void
      {
         ...
         var _loc3_:Boolean = Boolean(_context.saga) && _context.saga.isEternalArena;
         this.gp_cross.visible = _loc1_;
         this.gp_x.visible = _loc1_ && _loc2_;
         this._button$continue.visible = !_loc2_ && !_loc3_ && _loc1_;
         ...
         if(this._button_survival$continue.visible)
         {
            if(!this.victor)
            {
               this._button_survival$mr_gameover_cap.visible = true;
               this._button_survival$continue.visible = false;
               GuiGp.placeIconRight(this._button_survival$mr_gameover_cap,this.gp_cross);
            }
            else
            {
         ...
         if(this._button_survival$survival_reload.visible)
         {
            GuiGp.placeIconLeft(this._button_survival$survival_reload,this.gp_x);
            _loc4_ = _context.saga.survivalReloadCount;
            _loc5_ = _context.saga.survivalReloadLimit;
            if(_loc4_ >= _loc5_)
            {
               this._button_survival$survival_reload.enabled = false;
               this._button_survival$survival_reload.alpha = 0.5;
            }
            this._text_retries_remain.visible = true;
            this.replaceSurvivalText(this._text_retries_remain,"mr_retries_remain",_loc4_.toString(),_loc5_.toString());
         }
         this._button_ea$save.visible = _loc3_ && _loc1_;
         this._button_ea$edit.visible = _loc3_ && _loc1_;
         this._button_ea$retry.visible = _loc3_ && _loc1_;
         this._button_ea$quit.visible = _loc3_ && _loc1_;
         if(_loc3_ && _loc1_)
         {
            this.ea_nav.activate();
         }
      ...
      private function victoryOrDefeatDoneAnimating() : void
      {
         ...
         else if(_context.saga.isEternalArena)
         {
            TweenMax.delayedCall(0.6,this.renownGrowsDoneAnimating);
            return;
         }
      ...
      private function playRenownTotal() : void
      {
         ...
         var _loc1_:Boolean = _context.saga.isSurvival && !this.victor || _context.saga.isEternalArena;
      ...
      private function survivalGameoverCompleteHandler() : void
      {
         ...
         this.replaceSurvivalText(this._text_gameover_desc,"mr_gameover_progress",_context.saga.survivalProgress.toString(),_context.saga.survivalTotal.toString());
         this._text_retries_remain.visible = true;
         this.replaceSurvivalText(this._text_retries_remain,"mr_retries_remain",_context.saga.survivalReloadCount.toString(),_context.saga.survivalReloadLimit.toString());
         this.finished = true;
      }
      
      private function playEternalArenaScoring() : void
      {
         this._ea_score_holder.visible = true;
         this._ea_score_total.visible = true;
         var _loc1_:SagaEternalArena = context.saga.eternalArena;
         this.setupScore(_loc1_.scorecard);
         var _loc2_:Number = this._ea_score_holder.y;
         this._ea_score_holder.y -= this._ea_score_holder.height;
         TweenMax.to(this._ea_score_holder,0.5,{
            "y":_loc2_,
            "onComplete":this.scoreCompleteHandler
         });
      }
      
      private function scoreCompleteHandler() : void
      {
         this.finished = true;
      }
      
      private function setupScore(param1:EternalArenaScorecard) : void
      {
         var _loc3_:Parser = null;
         var _loc4_:String = null;
         var _loc5_:String = null;
         var _loc6_:GuiEAScoreElement = null;
         var _loc7_:Number = NaN;
         this._ea_score_total.setText("ea_score_total");
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  if(!(_loc5_ == null || _loc5_ == ""))
                  {
                     ...
                     _loc6_.init(context);
                     _loc6_.setText(_loc5_,"scoring_" + param1.scoring.id);
                     _loc7_ = param1.getSymbolValue(_loc4_,true);
                     _loc6_.setScore(_loc7_);
                     this._ea_score_holder.addChild(_loc6_);
                     _loc6_.y -= this._ea_score_objects.length * _loc6_.height * 1.1 + EA_SCORE_OFFSET;
                     this._ea_score_objects.push(_loc6_);
                  }
               }
            }
            _loc2_--;
      ...
      private function replaceSurvivalText(param1:TextField, param2:String, param3:String, param4:String) : void
      {
         ...
         _context.currentLocale.fixTextFieldFormat(param1);
      }
