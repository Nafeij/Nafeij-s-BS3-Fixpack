   ...
   public class GuiCharacterIconSlot extends GuiIconSlot implements IGuiCharacterIconSlot
   {
      ...
      override public function init(param1:IGuiContext) : void
      {
         ...
         if(Boolean(this._tooltip_stats) && Boolean(this.parent))
         {
            ...
            this._tooltip_stats.x = this.x - this._tooltip_stats.width;
      ...
      private function updatePlus() : void
      {
         ...
         if(_loc2_ < _loc3_)
         {
            ...
            {
               _loc10_ = true;
               if(Boolean(_loc1_) && (_loc1_.def.survival || _loc1_.isEternalArena))
               {
                  _loc10_ = false;
               }
               if(_loc10_)
         ...
         if(this._character.selectAdditionalAbility)
         {
            _loc7_ = 1;
         }
         if(_loc7_ > 0)
