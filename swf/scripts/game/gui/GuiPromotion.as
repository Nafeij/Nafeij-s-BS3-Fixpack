package game.gui
{
   ...
   import engine.saga.ea.EternalArenaTierDef;
   ...
   public class GuiPromotion extends GuiBase
   {
      ...
      public function init(param1:IGuiContext, param2:GuiPromotionConfig, param3:IGuiPromotionListener, param4:IGuiButton) : void
      {
         ...
         {
            this.renownBanner.visible = _context.useRenown;
         }
         if(this._renown_total)
         {
            this._renown_total.visible = _context.useRenown;
         }
      ...
      private function _handleAcceptClicked_ea() : void
      {
         var _loc3_:EternalArenaTierDef = null;
         var _loc1_:SagaEternalArena = !!_context.saga ? _context.saga.eternalArena : null;
         var _loc2_:EternalArenaArrangement = !!_loc1_ ? _loc1_.currentArrangement : null;
         if(_loc2_)
         {
            _loc3_ = _loc1_.def.getTierById(_loc2_.tierId);
            if(_loc3_)
            {
               if(this._entity.stats.rank >= _loc3_.player_maxrank)
               {
                  logger.error("promotion maxrank should have stopped us before we got here");
                  return;
               }
            }
         }
      ...
      private function onAcceptClicked(param1:ButtonWithIndex) : void
      {
         ...
         if(!_context.useRenown)
         {
            this._handleAcceptClicked_ea();
            return;
         }
      ...
      public function setEntity(param1:IEntityDef) : void
      {
         this.entity = param1;
      }
