package game.gui
{
   ...
   public class GuiSagaOptionsDifficulty extends GuiBase implements IGuiSagaOptionsDifficulty
   {
      ...
      private function setButtonsAsReadOnlyWithTooltip(param1:String) : void
      {
         this._button$easy.enabled = false;
         this._button$normal.enabled = false;
         this._button$hard.enabled = false;
         this.tooltip_text.htmlText = _context.translate(param1);
         this._tooltip.visible = true;
      }
      ...
      public function showSagaOptionsDifficulty(param1:int) : void
      {
         ...
         if(_context.saga.isSurvival)
         {
            this.setButtonsAsReadOnlyWithTooltip("survival_difficulty_locked");
         }
         else if(_context.saga.isEternalArena)
         {
            this.setButtonsAsReadOnlyWithTooltip("ea_difficulty_locked");
         }
         else
         {
