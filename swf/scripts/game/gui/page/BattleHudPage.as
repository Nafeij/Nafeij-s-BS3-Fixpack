package game.gui.page
{
   ...
   public class BattleHudPage extends GamePage implements IGuiPopupListener, IGuiInitiativeListener, IGuiOptionsListener, IGuiBattleHudListener, IGuiMovePopupListener, IGuiPropPopupListener, IGuiAbilityPopupListener
   {
      ...
      public var bhpEternalArenaHelper:BattleHudPageEternalArenaHelper;
      ...
      public function BattleHudPage(param1:GameConfig, param2:ScenePageBattleHandler, param3:BattleBoard, param4:BattleBoardView, param5:SceneViewSprite, param6:ShellCmdManager)
      {
         ...
         this.bhpEternalArenaHelper = new BattleHudPageEternalArenaHelper(this,param1);
         this.view = param4;
      ...
      override public function cleanup() : void
      {
         ...
         this.bhpEternalArenaHelper.cleanup();
         this.bhpEternalArenaHelper = null;
         this.turn = null;
         this.view = null;
      ...
      private function timerHandler(param1:TimerEvent) : void
      {
         ...
         var _loc2_:IBattleStateUserDeploying = this._fsm.current as IBattleStateUserDeploying;
         if(_loc2_)
         {
      ...
      override protected function resizeHandler() : void
      {
         ...
         this.bhpEternalArenaHelper.resizeHandler(width,height);
      ...
      private function _renderTriggerTooltip(param1:IBattleBoardTrigger, param2:Array) : Array
      {
         ...
         if(!param1.def.visible || !param1.enabled || param1.def.incorporeal && this._board.fsm.activeEntity && !this._board.fsm.activeEntity.incorporeal)
         {
            return param2;
         }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(this.bhpEternalArenaHelper)
         {
            this.bhpEternalArenaHelper.update(param1);
         }
      }
