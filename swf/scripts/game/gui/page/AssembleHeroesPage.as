package game.gui.page
{
   ...
   public class AssembleHeroesPage extends GamePage implements IGuiProvingGroundsListener
   {
      ...
      public static function generateIgnoramus(param1:ILogger) : Dictionary
      {
         var _loc2_:Dictionary = new Dictionary();
         var _loc3_:Saga = Saga.instance;
         if(Boolean(_loc3_) && _loc3_.isSurvival)
         {
            _loc2_["common__gui__pages__pg_backdrop"] = true;
            _loc2_["common__gui__pages__roster_team_banner"] = true;
            _loc2_["common__gui__pages__pg_top_banner"] = true;
            _loc2_["common__gui__pages__pg_foreground_doodads"] = true;
            switch(_loc3_.def.id)
            {
               case "saga2s":
                  addSurvival3Ignores(_loc2_);
                  break;
               case "saga3s":
                  addSurvival2Ignores(_loc2_);
                  break;
               default:
                  param1.e("SRV ","SagaSurvivalStartPage.get mcClazz(): Error, invalid saga.def.id, defaulting to mcClazz_saga2_survivalStart");
                  addSurvival3Ignores(_loc2_);
            }
         }
         else
         {
            _loc2_ = addSurvival2Ignores(_loc2_);
            _loc2_ = addSurvival3Ignores(_loc2_);
         }
         return _loc2_;
      }
      
      private static function addSurvival2Ignores(param1:Dictionary) : Dictionary
      {
         param1["common__gui__saga2_survival__heroes__party_background_right"] = true;
         param1["common__gui__saga2_survival__heroes__party_background_left"] = true;
         param1["common__gui__saga2_survival__heroes__background_right"] = true;
         param1["common__gui__saga2_survival__heroes__background_left"] = true;
         param1["common__gui__saga2_survival__heroes__top_banner_left"] = true;
         param1["common__gui__saga2_survival__heroes__top_banner_right"] = true;
         param1["common__gui__saga2_survival__heroes__foreground_left"] = true;
         param1["common__gui__saga2_survival__heroes__foreground_right"] = true;
         return param1;
      }
      
      private static function addSurvival3Ignores(param1:Dictionary) : Dictionary
      {
         param1["common__gui__saga3_survival__heroes__background_right"] = true;
         param1["common__gui__saga3_survival__heroes__background_left"] = true;
         param1["common__gui__saga3_survival__heroes__top_banner_left"] = true;
         param1["common__gui__saga3_survival__heroes__top_banner_right"] = true;
         param1["common__gui__saga3_survival__heroes__foreground_left"] = true;
         param1["common__gui__saga3_survival__heroes__foreground_right"] = true;
         return param1;
      }
      ...
      {
         var _loc1_:Dictionary = generateIgnoramus(logger);
      ...
      override protected function handleLoaded() : void
      {
         ...
         var _loc3_:SagaEternalArena = null;
         var _loc4_:GuiProvingGroundsConfig = null;
         ...
         if(fullScreenMc && !this.gui && (!HeroesPage.mcClazzAblPop || this.abilityPopup))
         {
            ...
            _loc2_ = config.saga;
            _loc3_ = !!_loc2_ ? _loc2_.eternalArena : null;
            if(!_loc1_)
            {
            ...
            _loc4_ = _loc1_.guiConfig;
            _loc4_.titleText = "assemble_your_heroes";
            _loc4_.isSaga = true;
            _loc4_.allowExit = false;
            _loc4_.allowRenown = !_loc3_;
            _loc4_.enableRenown = !_loc3_;
            _loc4_.allowDetails = true;
            _loc4_.roster.allowScrolling = _loc2_.isSurvival || _loc2_.isEternalArena;
            _loc4_.roster.allowExpandBarracks = false;
            _loc4_.roster.allowReady = true;
            _loc4_.roster.enableItems = true;
            _loc4_.roster.showPower = false;
            _loc4_.roster.showLimits = false;
            _loc4_.characterStats.bio.showServiceDays = false;
            _loc4_.characterStats.bio.showBattles = false;
            _loc4_.characterStats.bio.showColor = false;
            _loc4_.characterStats.bio.showRename = false;
            _loc4_.characterStats.bio.showDismiss = false;
