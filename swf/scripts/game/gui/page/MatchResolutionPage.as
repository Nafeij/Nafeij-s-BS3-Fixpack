package game.gui.page
{
   ...
   public class MatchResolutionPage extends GamePage implements IGuiMatchPageListener
   {
      ...
      public function bindKeyboard(param1:Boolean) : void
      {
         if(param1)
         {
      ...
      public function quitGameButtonClickHandler(param1:Object) : void
      {
         if(this.closedCallback != null)
         {
            ...
            config.fsm.current.data.setValue(GameStateDataEnum.EA_EDIT_CURRENT_ARENA,false);
      ...
      public function editEternalArenaClickHandler(param1:Object) : void
      {
         if(this.closedCallback != null)
         {
            config.fsm.current.data.setValue(GameStateDataEnum.REMATCH,false);
            config.fsm.current.data.setValue(GameStateDataEnum.EA_EDIT_CURRENT_ARENA,true);
            this.closedCallback(this);
         }
      }
      ...
      {
         return config.eaSaver.performSave(param1,param2,param3,param4);
      }
      
      public function guiEaSaveShowing(param1:Boolean) : void
      {
         this.bindKeyboard(!param1);
      }
   }
}
