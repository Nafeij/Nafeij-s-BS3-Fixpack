package game.gui.page
{
   ...
   public class HeroesPageCache
   {
      ...
      private function cachePartyPortraits() : void
      {
         ...
         this.gp.logger.info("cachePartyPortraits " + this.cachedPortraits);
         ...
         while(_loc2_ < this.party.numMembers)
         {
            ...
            if(!_loc3_)
            {
               this.gp.logger.error("cachePartyPortraits null party member " + _loc2_);
            }
            else
            {
               ...
               if(!_loc4_)
               {
                  this.gp.logger.error("cachePartyPortraits null party entityClassAppearanceDef for " + _loc2_ + " " + _loc3_);
               }
               else
               {
