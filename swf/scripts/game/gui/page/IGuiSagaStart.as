package game.gui.page
{
   ...
   public interface IGuiSagaStart extends IEventDispatcher
   {
      ...
      function init(param1:IGuiContext, param2:IGuiSagaStartListener, param3:Boolean, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:String = null) : void;
