package game.gui.page
{
   ...
   public class LoginPage extends GamePage implements IGuiLoginListener
   {
      ...
      private function parseMismatchMessage(param1:AuthBuildMismatchState) : String
      {
         ...
         var _loc3_:Array = config.context.appInfo.buildNumber.split(".");
         ...
         if(_loc4_)
         {
            _loc6_ = "Your Client Version " + config.context.appInfo.buildNumber + " is TOO NEW.  Server is " + param1.buildNumber;
         }
         else
         {
            _loc6_ = "Your Client Version " + config.context.appInfo.buildNumber + " is TOO OLD.  Server is " + param1.buildNumber;
         }
         return _loc6_;
      }
