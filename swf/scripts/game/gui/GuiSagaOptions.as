   ...
   public class GuiSagaOptions extends GuiBase implements IGuiSagaOptions
   {
      ...
      private function onQuitGameClicked(param1:Object) : void
      {
         ...
         else if(_loc2_.eternalArena)
         {
            ...
            {
               _loc5_ = context.translate("ea_quit_battle_title");
               _loc4_ = context.translate("ea_quit_battle_body");
            }
            else
            {
               _loc5_ = context.translate("ea_quit_title");
               _loc4_ = context.translate("ea_quit_body");
            }
         }
         else
         {
