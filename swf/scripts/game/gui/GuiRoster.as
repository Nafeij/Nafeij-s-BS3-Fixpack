package game.gui
{
   ...
   public class GuiRoster extends GuiBase implements IGuiRoster
   {
      ...
      private var _mouseWheelBuffer:Boolean = false;
      ...
      public function cleanup() : void
      {
         ...
         if(this.guiConfig && this.guiConfig.allowScrolling && this.guiConfig.allowMouseWheelScrolling)
         {
      ...
      public function init(param1:IGuiContext, param2:GuiRosterConfig, param3:MovieClip, param4:MovieClip, param5:Function) : void
      {
         ...
         else
         {
            ...
            if(param2.allowMouseWheelScrolling)
            {
      ...
      {
         if(this._mouseWheelBuffer)
         {
            return;
         }
         if(param1.delta > 0)
         {
            this.on_upArrow(this._upArrow);
         }
         else if(param1.delta < 0)
         {
            this.on_downArrow(this._downArrow);
         }
         this._mouseWheelBuffer = true;
         TweenMax.delayedCall(0.15,this.endMouseWheelBuffer);
      }
      
      private function endMouseWheelBuffer() : void
      {
         this._mouseWheelBuffer = false;
      }
      ...
      private function killRosterTweens() : void
      {
         ...
         TweenMax.killDelayedCallsTo(this.endMouseWheelBuffer);
      }
   }
}
