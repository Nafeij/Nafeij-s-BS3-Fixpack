package game.gui
{
   ...
   import assets.saga3_ea_challenge_warning;
   import assets.saga3_ea_leaderboards;
   import assets.saga3_ea_setup;
   import assets.saga3_ea_start;
   import assets.saga3_newgame;
   import assets.saga3_survival_start;
   ...
   import game.gui.pages.GuiSagaEternalArenaSetup_IconsGlob;
   ...
   public class InitializeGui
   {
      ...
      public static function initializeGuis(param1:Boolean, param2:ILogger) : void
      {
         ...
         SagaSurvivalStartPage.mcClazz_saga2_survivalStart = checkGuiClass(param1,saga2_survival_start,param2);
         SagaSurvivalStartPage.mcClazz_saga3_survivalStart = checkGuiClass(param1,saga3_survival_start,param2);
         ...
         SagaEternalArenaStartPage.mcClazz_saga3_eternalArenaStart = checkGuiClass(param1,saga3_ea_start,param2);
         SagaEternalArenaSetupPage.mcClazz_saga3_eternalArenaSetup = checkGuiClass(param1,saga3_ea_setup,param2);
         SagaEternalArenaSetupPage.mcClazz_saga3_eternalArenaChallengeWarning = checkGuiClass(param1,saga3_ea_challenge_warning,param2);
         SagaEternalArenaLeaderboardsPage.mcClazz_saga3_eternalArenaLeaderboards = checkGuiClass(param1,saga3_ea_leaderboards,param2);
         GuiEAScoreElement.mcClazz = checkGuiClass(param1,ea_score_holder,param2);
         ...
         GuiSagaEternalArenaSetup_IconsGlob.mcStatTooltipClazz = checkGuiClass(param1,stat_tooltip,param2);
         GuiSagaEternalArenaSetup_IconsGlob.mcNameTooltipClazz = checkGuiClass(param1,name_tooltip,param2);
