package game.session.states
{
   ...
   public class GameStateDataEnum extends StateDataEnum
   {
      ...
      public static const EA_ARRANGEMENT:GameStateDataEnum = new GameStateDataEnum("EA_ARRANGEMENT",enumCtorKey);
      
      public static const EA_ARRANGEMENT_READONLY:GameStateDataEnum = new GameStateDataEnum("EA_ARRANGEMENT_READONLY",enumCtorKey);
      
      public static const EA_EDIT_CURRENT_ARENA:GameStateDataEnum = new GameStateDataEnum("EA_EDIT_CURRENT_ARENA",enumCtorKey);
