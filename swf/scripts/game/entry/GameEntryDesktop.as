   ...
   public class GameEntryDesktop extends GameEntry
   {
      ...
      protected function initWrapper(param1:int, param2:Array) : GameWrapper
      {
         ...
         else
         {
            ...
            _loc4_ = param1 > 0 ? wrappers[0].appInfo.buildNumber : appInfo.buildNumber;
      ...
      private function setDebug(param1:Boolean) : void
      {
         ...
         for each(_loc2_ in wrappers)
         {
            (_loc2_.logger as Logger).isDebugEnabled = param1;
         }
      }
      ...
      protected function processArgument(param1:String) : Boolean
      {
         ...
         else if(this.checkArg(param1,"qacheat"))
         {
            SagaCheat.ALLOW = this._argBool;
         }
         ...
         else if(this.checkArg(param1,"build_number"))
         {
            _loc5_ = this._argValue;
            for each(_loc3_ in wrappers)
            {
               _loc3_.appInfo.buildInfo.id.number = _loc5_;
            }
         }
         ...
         else if(this.checkArg(param1,"eternal_arena"))
         {
            SagaDef.ETERNAL_ARENA_ENABLED = this._argBool;
         }
         ...
         else if(this.checkArg(param1,"show_scaled_text_borders"))
         {
            GuiUtil.SHOW_TEXTFIELD_BORDERS = true;
         }
         else if(this.checkArg(param1,"ea_url"))
         {
            EternalArenaConfig.HOST_URL = this._argValue;
            SagaCheat.devCheat("args " + param1);
         }
         else if(this.checkArg(param1,"ea_debug"))
         {
            EternalArenaConfig.DEBUG = this._argBool;
            this.setDebug(this.debug || this._argBool);
         }
         else
         {
            if(!this.checkArg(param1,"environment"))
            {
            ...
            Platform.environment = this._argValue;
         }
         return true;
      }
      ...
      protected function startRefereum() : void
      {
         Refereum.initialize(appInfo.logger,appInfo);
      }
      ...
      override protected function handleDoSetup() : Boolean
      {
         ...
         EngineJsonDef._validateRuntime = EngineJsonDefImpl.validate;
      ...
      protected function startGame() : void
      {
         ...
         {
            _loc3_ += "  Steam " + this.userId + " PREVIEW " + appInfo.buildNumber;
            _loc4_ = true;
         }
         else if(this.betaBranch == "beta")
         {
            _loc3_ += "  Steam " + this.userId + " BETA " + appInfo.buildNumber;
            _loc4_ = true;
         }
      ...
      private function _createPiratemark() : void
      {
         ...
         var _loc1_:String = "";
         _loc1_ += "  SEASICK " + this.userId + " " + this.betaBranch + " " + appInfo.buildNumber;
      ...
      protected function setSoundDriver(param1:Class) : void
      {
         var _loc2_:GameWrapper = null;
         var _loc3_:int = 0;
