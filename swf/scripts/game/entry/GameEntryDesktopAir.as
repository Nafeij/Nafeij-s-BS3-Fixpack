package game.entry
{
   ...
   public class GameEntryDesktopAir extends GameEntryDesktop
   {
      ...
      public static var soundDriver:Class = NullSoundDriver;
      ...
      public function GameEntryDesktopAir(param1:GuiApplication, param2:BuildInfo)
      {
         this.exitTimer = new Timer(500,1);
         super(param1,new AirAppInfo(param1,param2,0),soundDriver,File.userDirectory.url,NativeText,GameDevSocket,SaveManagerAir);
      ...
      {
         logError("currently disabled due to a dependency cleanup");
         if(param1)
         {
            this.debug = param1;
         }
      ...
      private function startGa_reportUnknown() : void
      {
         ...
         Ga.minimal("unknown","build",appInfo.buildNumber,_loc2_);
