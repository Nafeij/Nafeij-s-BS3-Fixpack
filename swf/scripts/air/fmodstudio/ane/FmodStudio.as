package air.fmodstudio.ane
{
   ...
   public class FmodStudio implements IEventDispatcher
   {
      ...
      public function refereumInitialize(param1:String, param2:String, param3:String, param4:Boolean) : Boolean
      {
         return this.context.call("refereumInit_Threaded",param1,param2,param3,param4);
      }
   }
}
