package com.stoicstudio.platform.steam
{
   ...
   public final class SteamEntryHelper implements IEntryHelperDesktop
   {
      ...
      private function _computeEnvironment() : void
      {
         if(Platform.environment)
         {
            this.logInfo("_computeEnvironment Platform.environment preserving [" + Platform.environment + "]");
         }
         else if(Capabilities.isDebugger)
         {
            this.logInfo("_computeEnvironmentPlatform.environment debugger");
            Platform.environment = "dev";
         }
         else if(this.beta)
         {
            Platform.environment = this.beta;
            this.logInfo("_computeEnvironment Platform.environment beta [" + Platform.environment + "]");
         }
         this.logInfo("_computeEnvironment Platform.environment [" + Platform.environment + "]");
      }
